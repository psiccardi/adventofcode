self.exercise1 = {
    text1: `<article class="day-desc"><h2>--- Day 1: Trebuchet?! ---</h2><p>Something is wrong with global snow production, and you've been selected to take a look. The Elves have even given you a map; on it, they've used stars to mark the top fifty locations that are likely to be having problems.</p>
...
self.exercise1.helpers = {};

self.exercise1._executeFirst = (data) => {

}

self.exercise1._executeSecond = (data) => {
    
}

self.exercise1.executeFirst = () => {
   
}


self.exercise1.executeSecond = () => {
